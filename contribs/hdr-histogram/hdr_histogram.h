 ...
 * true otherwise.
 */
int hdr_record_corrected_value(struct hdr_histogram* h, int64_t value, int64_t expexcted_interval);
...
struct hdr_iter
{
    ...
    int (*_next_fp)(struct hdr_iter* iter);
};
...
int hdr_shift_values_right(struct hdr_histogram* h, int32_t shift);
