...
if (MSVC)
    ...
    if (CMAKE_EXE_LINKER_FLAGS_MINRELSIZE)
        STRING(REPLACE "INCREMENTAL" "INCREMENTAL:NO" replacementFlags3 ${CMAKE_EXE_LINKER_FLAGS_MINRELSIZE})
        SET(CMAKE_EXE_LINKER_FLAGS_MINRELSIZE ${replacementFlags3})
        SET(CMAKE_EXE_LINKER_FLAGS_MINRELSIZE "/INCREMENTAL:NO ${replacementFlags3}" )
    endif()
endif()
