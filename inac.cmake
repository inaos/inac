...
function(inac_add_tests)
    ...
    file(GLOB src ${CMAKE_SOURCE_DIR}/tests/test_*.c ${CMAKE_SOURCE_DIR}/tests/helper_*.c CMAKE_SOURCE_DIR}/tests/test_*.cxx ${CMAKE_SOURCE_DIR}/tests/helper_*.cxx CMAKE_SOURCE_DIR}/tests/test_*.cpp ${CMAKE_SOURCE_DIR}/tests/helper_*.cpp CMAKE_SOURCE_DIR}/tests/test_*.cc ${CMAKE_SOURCE_DIR}/tests/helper_*.cc)
...
function(inac_artifact_name name version output_var)
    if (MSVC)
        ...
        elseif($ENV{VisualStudioVersion} STREQUAL "17.0")
            string(APPEND ARTIFACT_NAME "${name}-${CMAKE_SYSTEM_NAME}_vs22-${INAC_TARGET_ARCH}-${CMAKE_BUILD_TYPE}-${version}")
		else()
