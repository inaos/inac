...
/* Define test case */
#ifdef INA_OS_WINDOWS
#define INA_TEST_DATA_WINDOWS(sname) INA_TEST_DATA(sname##_win32)
#define INA_TEST_SETUP_WINDOWS(sname) INA_TEST_SETUP(sname##_win32)
#define INA_TEST_TEARDOWN_WINDOWS(sname) INA_TEST_TEARDOWN(sname##_win32)
#define INA_TEST_WINDOWS(sname, tname) INA_TEST(sname##_win32, tname##_win32)
#define INA_TEST_SKIP_WINDOWS(sname, tname) INA_TEST_SKIP(sname##_win32, tname##_win32)
#define INA_TEST_FIXTURE_WINDOWS(sname, tname) INA_TEST_FIXTURE(sname##_win32, tname##_win32)
#define INA_TEST_FIXTURE_SKIP_WINDOWS(sname, tname) INA_TEST_FIXTURE_SKIP(sname##_win32, tname##_win32)
#else
#define INA_TEST_DATA_WINDOWS(sname) INA_TEST_DATA(sname##_win32)
#define INA_TEST_SETUP_WINDOWS(sname) INA_TEST_SETUP(sname##_win32)
#define INA_TEST_TEARDOWN_WINDOWS(sname) INA_TEST_TEARDOWN(sname##_win32)
#define INA_TEST_WINDOWS(sname, tname) INA_TEST_NO_DATA(sname##_win32, tname##_win32);void x__ina_test_win32_##sname##_##tname(struct sname##_win32##tname##_win32_data* data)
...
#define INA_TEST_OSX(sname, tname) INA_TEST(sname##_osx, tname##_osx)
#define INA_TEST_SKIP_OSX(sname, tname) INA_TEST_SKIP(sname##_osx, tname##_osx)
#define INA_TEST_FIXTURE_OSX(sname, tname) INA_TEST_FIXTURE(sname##_osx, tname##_osx)
#define INA_TEST_FIXTURE_SKIP_OSX(sname, tname) INA_TEST_FIXTURE_SKIP(sname##_osx, tname##_osx)
#else
#define INA_TEST_DATA_OSX(sname) INA_TEST_DATA(sname##_osx)
#define INA_TEST_SETUP_OSX(sname) INA_TEST_SETUP(sname##_osx)
#define INA_TEST_TEARDOWN_OSX(sname) INA_TEST_TEARDOWN(sname##_osx)
#define INA_TEST_OSX(sname, tname) INA_TEST_NO_DATA(sname##_osx, tname##_osx);void x__ina_test_osx_##sname##_##tname(struct sname##_osx##tname##_osx_data* data)
...
#define INA_TEST_TEARDOWN_LINUX(sname) INA_TEST_TEARDOWN(sname##_osx)
#define INA_TEST_LINUX(sname, tname) INA_TEST(sname##_linux, tname##_linux)
#define INA_TEST_SKIP_LINUX(sname, tname) INA_TEST_SKIP(sname##_linux, tname##_linux)
#define INA_TEST_FIXTURE_LINUX(sname, tname) INA_TEST_FIXTURE(sname##_linux, tname##_linux)
#define INA_TEST_FIXTURE_SKIP_LINUX(sname, tname) INA_TEST_FIXTURE_SKIP(sname##_linux, tname##_linux)
#else
#define INA_TEST_DATA_LINUX(sname) INA_TEST_DATA(sname##_linux)
#define INA_TEST_SETUP_LINUX(sname) INA_TEST_SETUP(sname##_linux)
#define INA_TEST_TEARDOWN_LINUX(sname) INA_TEST_TEARDOWN(sname##_linux)
#define INA_TEST_LINUX(sname, tname) INA_TEST_NO_DATA(sname##_linux, tname##_linux);void x__ina_test_linux_##sname##_##tname(struct sname##_linux##tname##_linux_data* data)
