...
#define INA_RC_ERRCDE(rc)  ((int32_t)(((rc) >> INA_RC_BIT_A) & 0xff))
#define INA_RC_ERROR(rc)  ((int32_t)(((rc) >> INA_RC_BIT_A) & 0xff))
#define INA_RC_SUBJECT(rc)  ((int32_t)(((rc) >> INA_RC_BIT_U) & 0x7fff))
