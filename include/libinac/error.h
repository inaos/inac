...
#define INA_RC_BIT_A 15U
#define INA_RC_BIT_S 00U

#define INA_RC_EFLAG(rc)   ((uint32_t)(((rc) >> INA_RC_BIT_E) & 0x1))
#define INA_RC_VER(rc)     ((uint32_t)(((rc) >> INA_RC_BIT_V) & 0x7F))
#define INA_RC_REV(rc)     ((uint32_t)(((rc) >> INA_RC_BIT_R) & 0xFFFF))
#define INA_RC_ERRNO(rc)   ((uint32_t)(((rc) >> INA_RC_BIT_O) & 0xFFFF))
#define INA_RC_NFLAG(rc)   ((uint32_t)(((rc) >> INA_RC_BIT_N) & 0x1))
#define INA_RC_ADJ(rc)     ((uint32_t)((rc)&( 0xFFULL << INA_RC_BIT_A)))
#define INA_RC_SUBJECT(rc) ((uint32_t)(((rc) >> INA_RC_BIT_S) & 0x7FFF))
#define INA_RC_ERROR(rc)  ((uint32_t)((INA_MID_BITS((rc), INA_RC_BIT_A, INA_RC_BIT_N+1))<<INA_RC_BIT_A))
#define INA_RC_ERRMSG(rc)  ((uint32_t)(((uint32_t)(((rc) >> INA_RC_BIT_N)))))
...
/* Error codes */
#define INA_ERR_A                   (  1ULL << INA_RC_BIT_A)
#define INA_ERR_ACK                 (  2ULL << INA_RC_BIT_A)
#define INA_ERR_ACTIVE              (  3ULL << INA_RC_BIT_A)
#define INA_ERR_ALIGNED             (  4ULL << INA_RC_BIT_A)
#define INA_ERR_ALLOWED             (  5ULL << INA_RC_BIT_A)
#define INA_ERR_ASSIGNED            (  6ULL << INA_RC_BIT_A)
#define INA_ERR_ATTACHED            (  7ULL << INA_RC_BIT_A)
#define INA_ERR_ATTEMPTED           (  8ULL << INA_RC_BIT_A)
#define INA_ERR_AUTHORIZED          (  9ULL << INA_RC_BIT_A)
#define INA_ERR_AVAILABLE           ( 10ULL << INA_RC_BIT_A)
#define INA_ERR_BAD                 ( 11ULL << INA_RC_BIT_A)
#define INA_ERR_BLOCKED             ( 12ULL << INA_RC_BIT_A)
#define INA_ERR_BROKEN              ( 13ULL << INA_RC_BIT_A)
#define INA_ERR_BUILT               ( 14ULL << INA_RC_BIT_A)
#define INA_ERR_BUSY                ( 15ULL << INA_RC_BIT_A)
#define INA_ERR_CLOSED              ( 16ULL << INA_RC_BIT_A)
#define INA_ERR_COLLIDED            ( 17ULL << INA_RC_BIT_A)
#define INA_ERR_COMPILED            ( 18ULL << INA_RC_BIT_A)
#define INA_ERR_COMPLETE            ( 19ULL << INA_RC_BIT_A)
#define INA_ERR_CONFLICTED          ( 20ULL << INA_RC_BIT_A)
#define INA_ERR_CONNECTED           ( 21ULL << INA_RC_BIT_A)
#define INA_ERR_CONSTRUCTED         ( 22ULL << INA_RC_BIT_A)
#define INA_ERR_CREATED             ( 23ULL << INA_RC_BIT_A)
#define INA_ERR_DEFINED             ( 24ULL << INA_RC_BIT_A)
#define INA_ERR_DENIED              ( 25ULL << INA_RC_BIT_A)
#define INA_ERR_DEPARTED            ( 26ULL << INA_RC_BIT_A)
#define INA_ERR_DESTRUCTED          ( 27ULL << INA_RC_BIT_A)
#define INA_ERR_DETACHED            ( 28ULL << INA_RC_BIT_A)
#define INA_ERR_DETECTED            ( 29ULL << INA_RC_BIT_A)
#define INA_ERR_DISABLED            ( 30ULL << INA_RC_BIT_A)
#define INA_ERR_DOWN                ( 31ULL << INA_RC_BIT_A)
#define INA_ERR_DOWNLOADED          ( 32ULL << INA_RC_BIT_A)
#define INA_ERR_EMPTY               ( 33ULL << INA_RC_BIT_A)
#define INA_ERR_ENABLED             ( 34ULL << INA_RC_BIT_A)
#define INA_ERR_ENHANCED            ( 35ULL << INA_RC_BIT_A)
#define INA_ERR_ENOUGH              ( 36ULL << INA_RC_BIT_A)
#define INA_ERR_EXCEEDED            ( 37ULL << INA_RC_BIT_A)
#define INA_ERR_EXCHANGED           ( 38ULL << INA_RC_BIT_A)
#define INA_ERR_EXECUTABLE          ( 39ULL << INA_RC_BIT_A)
#define INA_ERR_EXISTS              ( 40ULL << INA_RC_BIT_A)
#define INA_ERR_EXPIRED             ( 41ULL << INA_RC_BIT_A)
#define INA_ERR_EXTENDED            ( 42ULL << INA_RC_BIT_A)
#define INA_ERR_FAILED              ( 43ULL << INA_RC_BIT_A)
#define INA_ERR_FALSE               ( 44ULL << INA_RC_BIT_A)
#define INA_ERR_FATAL               ( 45ULL << INA_RC_BIT_A)
#define INA_ERR_FORBIDDEN           ( 46ULL << INA_RC_BIT_A)
#define INA_ERR_FORMATTED           ( 47ULL << INA_RC_BIT_A)
#define INA_ERR_FOUND               ( 48ULL << INA_RC_BIT_A)
#define INA_ERR_FULL                ( 49ULL << INA_RC_BIT_A)
#define INA_ERR_GONE                ( 50ULL << INA_RC_BIT_A)
#define INA_ERR_GOOD                ( 51ULL << INA_RC_BIT_A)
#define INA_ERR_HALTED              ( 52ULL << INA_RC_BIT_A)
#define INA_ERR_HIDDEN              ( 53ULL << INA_RC_BIT_A)
#define INA_ERR_HOLD                ( 54ULL << INA_RC_BIT_A)
#define INA_ERR_IDLE                ( 55ULL << INA_RC_BIT_A)
#define INA_ERR_ILLEGAL             ( 56ULL << INA_RC_BIT_A)
#define INA_ERR_IMPLEMENTED         ( 57ULL << INA_RC_BIT_A)
#define INA_ERR_IN_PROGRESS         ( 58ULL << INA_RC_BIT_A)
#define INA_ERR_IN_USE              ( 59ULL << INA_RC_BIT_A)
#define INA_ERR_INITIALIZED         ( 60ULL << INA_RC_BIT_A)
#define INA_ERR_INSERTED            ( 61ULL << INA_RC_BIT_A)
#define INA_ERR_INSTALLED           ( 62ULL << INA_RC_BIT_A)
#define INA_ERR_INTERRUPTED         ( 63ULL << INA_RC_BIT_A)
#define INA_ERR_JOINED              ( 64ULL << INA_RC_BIT_A)
#define INA_ERR_KNOWN               ( 65ULL << INA_RC_BIT_A)
#define INA_ERR_LINKED              ( 66ULL << INA_RC_BIT_A)
#define INA_ERR_LOADED              ( 67ULL << INA_RC_BIT_A)
#define INA_ERR_LOCAL               ( 68ULL << INA_RC_BIT_A)
#define INA_ERR_LOCKED              ( 69ULL << INA_RC_BIT_A)
#define INA_ERR_LOOPED              ( 70ULL << INA_RC_BIT_A)
#define INA_ERR_LOST                ( 71ULL << INA_RC_BIT_A)
#define INA_ERR_MERGED              ( 72ULL << INA_RC_BIT_A)
#define INA_ERR_MISSING             ( 73ULL << INA_RC_BIT_A)
#define INA_ERR_MOUNTED             ( 74ULL << INA_RC_BIT_A)
#define INA_ERR_NEEDED              ( 75ULL << INA_RC_BIT_A)
#define INA_ERR_NO                  ( 76ULL << INA_RC_BIT_A)
#define INA_ERR_NO_SUCH             ( 77ULL << INA_RC_BIT_A)
#define INA_ERR_OFF                 ( 78ULL << INA_RC_BIT_A)
#define INA_ERR_ON                  ( 79ULL << INA_RC_BIT_A)
#define INA_ERR_ONLINE              ( 80ULL << INA_RC_BIT_A)
#define INA_ERR_OPEN                ( 81ULL << INA_RC_BIT_A)
#define INA_ERR_ORDERED             ( 82ULL << INA_RC_BIT_A)
#define INA_ERR_OUT_OF              ( 83ULL << INA_RC_BIT_A)
#define INA_ERR_OUT_OF_RANGE        ( 84ULL << INA_RC_BIT_A)
#define INA_ERR_OVERFLOW            ( 85ULL << INA_RC_BIT_A)
#define INA_ERR_PADDED              ( 86ULL << INA_RC_BIT_A)
#define INA_ERR_PARTED              ( 87ULL << INA_RC_BIT_A)
#define INA_ERR_PERMITTED           ( 88ULL << INA_RC_BIT_A)
#define INA_ERR_POPPED              ( 89ULL << INA_RC_BIT_A)
#define INA_ERR_PRELOADED           ( 90ULL << INA_RC_BIT_A)
#define INA_ERR_PROCESSABLE         ( 91ULL << INA_RC_BIT_A)
#define INA_ERR_PROVIDED            ( 92ULL << INA_RC_BIT_A)
#define INA_ERR_PUSHED              ( 93ULL << INA_RC_BIT_A)
#define INA_ERR_REACHABLE           ( 94ULL << INA_RC_BIT_A)
#define INA_ERR_READABLE            ( 95ULL << INA_RC_BIT_A)
#define INA_ERR_RECEIVED            ( 96ULL << INA_RC_BIT_A)
#define INA_ERR_REFUSED             ( 97ULL << INA_RC_BIT_A)
#define INA_ERR_REGISTERED          ( 98ULL << INA_RC_BIT_A)
#define INA_ERR_REJECTED            ( 99ULL << INA_RC_BIT_A)
#define INA_ERR_RELEASED            (100ULL << INA_RC_BIT_A)
#define INA_ERR_REMOTE              (101ULL << INA_RC_BIT_A)
#define INA_ERR_REMOVED             (102ULL << INA_RC_BIT_A)
#define INA_ERR_RENDERABLE          (103ULL << INA_RC_BIT_A)
#define INA_ERR_RESERVED            (104ULL << INA_RC_BIT_A)
#define INA_ERR_RESET               (105ULL << INA_RC_BIT_A)
#define INA_ERR_RESPONDING          (106ULL << INA_RC_BIT_A)
#define INA_ERR_RETRIED             (107ULL << INA_RC_BIT_A)
#define INA_ERR_RIGHT               (108ULL << INA_RC_BIT_A)
#define INA_ERR_RUNNING             (109ULL << INA_RC_BIT_A)
#define INA_ERR_SENT                (110ULL << INA_RC_BIT_A)
#define INA_ERR_SHARED              (111ULL << INA_RC_BIT_A)
#define INA_ERR_SORTED              (112ULL << INA_RC_BIT_A)
#define INA_ERR_SPECIFIED           (113ULL << INA_RC_BIT_A)
#define INA_ERR_SPLITTED            (114ULL << INA_RC_BIT_A)
#define INA_ERR_STALLED             (115ULL << INA_RC_BIT_A)
#define INA_ERR_STOPPED             (116ULL << INA_RC_BIT_A)
#define INA_ERR_SUCEEDED            (117ULL << INA_RC_BIT_A)
#define INA_ERR_SUITABLE            (118ULL << INA_RC_BIT_A)
#define INA_ERR_SUPPORTED           (119ULL << INA_RC_BIT_A)
#define INA_ERR_SYNCHRONIZED        (120ULL << INA_RC_BIT_A)
#define INA_ERR_TERMINATED          (121ULL << INA_RC_BIT_A)
#define INA_ERR_THROWN              (122ULL << INA_RC_BIT_A)
#define INA_ERR_TIMED_OUT           (123ULL << INA_RC_BIT_A)
#define INA_ERR_TOO_COMPLEX         (124ULL << INA_RC_BIT_A)
#define INA_ERR_TOO_FEW             (125ULL << INA_RC_BIT_A)
#define INA_ERR_TOO_LARGE           (126ULL << INA_RC_BIT_A)
#define INA_ERR_TOO_LONG            (127ULL << INA_RC_BIT_A)
#define INA_ERR_TOO_MANY            (128ULL << INA_RC_BIT_A)
#define INA_ERR_TOO_MUCH            (129ULL << INA_RC_BIT_A)
#define INA_ERR_TOO_SIMPLE          (130ULL << INA_RC_BIT_A)
#define INA_ERR_TOO_SMALL           (131ULL << INA_RC_BIT_A)
#define INA_ERR_TRIGGERED           (132ULL << INA_RC_BIT_A)
#define INA_ERR_TRUE                (133ULL << INA_RC_BIT_A)
#define INA_ERR_UNBLOCKED           (134ULL << INA_RC_BIT_A)
#define INA_ERR_UNDERFLOW           (135ULL << INA_RC_BIT_A)
#define INA_ERR_UNINITIALIZED       (136ULL << INA_RC_BIT_A)
#define INA_ERR_UNINSTALLED         (137ULL << INA_RC_BIT_A)
#define INA_ERR_UNIQUE              (138ULL << INA_RC_BIT_A)
#define INA_ERR_UNLOADED            (139ULL << INA_RC_BIT_A)
#define INA_ERR_UNLOCKED            (140ULL << INA_RC_BIT_A)
#define INA_ERR_UNSORTED            (141ULL << INA_RC_BIT_A)
#define INA_ERR_UP                  (142ULL << INA_RC_BIT_A)
#define INA_ERR_UPDATED             (143ULL << INA_RC_BIT_A)
#define INA_ERR_UPGRADED            (144ULL << INA_RC_BIT_A)
#define INA_ERR_UPLOADED            (145ULL << INA_RC_BIT_A)
#define INA_ERR_USED                (146ULL << INA_RC_BIT_A)
#define INA_ERR_VALID               (147ULL << INA_RC_BIT_A)
#define INA_ERR_VISIBLE             (148ULL << INA_RC_BIT_A)
#define INA_ERR_WORKING             (149ULL << INA_RC_BIT_A)
#define INA_ERR_WRITABLE            (150ULL << INA_RC_BIT_A)
#define INA_ERR_WRONG               (151ULL << INA_RC_BIT_A)
#define INA_ERR_END_OF              (152ULL << INA_RC_BIT_A)
#define INA_ERR_RESOLVED            (153ULL << INA_RC_BIT_A)
#define INA_ERR_MATCH               (154ULL << INA_RC_BIT_A)
#define INA_ERR_TRY_AGAIN           (155ULL << INA_RC_BIT_A)
#define INA_ERR_PARSED              (156ULL << INA_RC_BIT_A)
#define INA_ERR_CHANGED             (157ULL << INA_RC_BIT_A)
