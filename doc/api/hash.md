...
```C
typedef uint32_t (*ina_hash_func_32_t)(uint32_t hash, const void *data, size_t size);typedef uint64_t (*ina_hash_func_64_t)(uint64_t hash, const void *data, size_t size);
```
