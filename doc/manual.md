...
The INAOS C Common library is a collection of header files and library routines used to implement common operations, such as input/output, character string handling and memory handling. This library is design only for singled threaded applications and is used as common base for all INOAS programs/libraries written in C.

With this library we follow the approach to be minimal but complete.
